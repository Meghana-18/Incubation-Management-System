...
function StartupLoginButton(props){
    ...
    return (<div className="mainDiv">
        ...
        <button type="button" className="btn btn-outline-light Rectangle-45 "  onClick={() => {history.push("/Startupsignup");}}>{props.button1}</button>
        </div>
        <div>
        ...
        <button type="submit" class="Rectangle-40" onClick={() => {history.push("/Startupdashboard");}}>{props.button3}</button>
        </form>
        </div>
...
export default StartupLoginButton;