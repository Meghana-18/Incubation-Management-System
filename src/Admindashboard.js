...
function Admindashboard(){
    ...
    return(
        ...
        />
        <Figure.Caption>
            Admin<br /> System administrator for this application, overlooking everything.  
        </Figure.Caption>
        </Figure>
        ...
        <Card>
            ...
            <Card.Text>
            Symbiosis Center for Entrepreneurship and Innovation <br />
            Incubating over 500 Startups yearly.
            </Card.Text>
            </Card.Body>
            <Card.Footer>
            <small className="text-muted">Last updated 3 mins ago</small>
        ...
        <Card>
            ...
            <Card.Text>
                <ul>
                <li>Website : www.scei.edu.in</li>
                <li>Email : head@scei.org.in</li>
                <li>Adress: Near Lupin Research Park, Lavale, Pune, Maharashtra, India</li>
            </ul>
            </Card.Text>
            </Card.Body>
            <Card.Footer>
