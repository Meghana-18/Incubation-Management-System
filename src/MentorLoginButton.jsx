...
function MentorLoginButton(props){
    ...
    return (<div className="mainDiv">
        ...
        <button type="button" className="btn btn-outline-light Rectangle-45 " onClick={() => {history.push("/Mentorsignup");}} >{props.button1}</button>
        </div>
        <div>
        ...
        <button type="submit" class="Rectangle-40" onClick={() => {history.push("/Mentordashboard");}}>{props.button3}</button>
        </form>
        </div>
...
export default MentorLoginButton;